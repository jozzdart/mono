...
void main() {
  final commands = <CommandEntry>[
    ...
    const CommandEntry(
        ...
        title: 'Go to File...',
        subtitle: 'Quickly open files by name'),
    const CommandEntry(
        id: 'workbench.action.showCommands',
        title: 'Show All Commands',
        subtitle: 'Display available commands'),
    const CommandEntry(
        id: 'editor.action.rename',
        title: 'Rename Symbol',
        subtitle: 'Change all references'),
    const CommandEntry(
        id: 'editor.action.formatDocument',
        title: 'Format Document',
        subtitle: 'Apply code formatter'),
    const CommandEntry(
        id: 'workbench.action.closeAllEditors', title: 'Close All Editors'),
    const CommandEntry(
        id: 'workbench.action.toggleZenMode', title: 'Toggle Zen Mode'),
    const CommandEntry(
    ...
    const CommandEntry(
        id: 'git.commit',
        title: 'Git: Commit',
        subtitle: 'Commit staged changes'),
  ];
