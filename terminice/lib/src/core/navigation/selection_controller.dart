...
/// - Handling of empty selection with fallback to focused item
///
/// **Design:**
/// - Separation of concerns: selection is separate from navigation
/// - Composition over inheritance: combine with any navigation
/// - Works with indices, so it's item-type agnostic
///
/// **Single-select usage:**
/// ```dart
...
///
/// // Get result
/// final selectedItem = sel.getSelected(items, fallbackIndex: nav.selectedIndex);
/// ```
///
/// **Multi-select usage:**
/// ```dart
...
///
/// // Get all selected
/// final selected = sel.getSelectedMany(items);
/// ```
///
/// **Integration with KeyBindings:**
/// ```dart
/// final bindings = KeyBindings.toggle(onToggle: () => sel.toggle(nav.selectedIndex));
/// ```
